...
class Sidebar_Manager {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'carbon-sidebar-manager', plugins_url('/ed-inventory-ultimate/vendor/htmlburger/carbon-fields') . '/core/Libraries/Sidebar_Manager/assets/css/app.css', array(), \Carbon_Fields\VERSION );
		wp_enqueue_script( 'carbon-sidebar-manager', plugins_url('/ed-inventory-ultimate/vendor/htmlburger/carbon-fields') . '/core/Libraries/Sidebar_Manager/assets/js/app.js', array(), \Carbon_Fields\VERSION );
